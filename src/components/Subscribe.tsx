...
const Subscribe = () => {
  ...
  return (
    <section id="subscribe" className="py-24 bg-secondary/50">
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          {isSubscribed ? (
            <div className="bg-primary/10 text-primary p-6 rounded-2xl inline-flex items-center gap-3">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              <button
                type="submit"
                className="px-8 py-4 bg-primary text-primary-foreground font-medium rounded-xl hover:bg-primary/90 transition-all hover-lift shadow-warm whitespace-nowrap"
              >
                Подписаться
              </button>
            </form>
          ...
          <p className="text-sm text-muted-foreground mt-4">
            Присоединяйтесь к 1,000+ читателям
          </p>
        </div>
      </div>
    </section>
